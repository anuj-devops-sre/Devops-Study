# 🚀 Devops-Study: The Ultimate SRE & Platform Engineering Path

This repository is a structured, hands-on roadmap for mastering DevOps and Site Reliability Engineering. It covers everything from fundamentals to advanced production-grade infrastructure.

---

## 🗺️ Master Study Guides
High-quality, consolidated technical notes for easier learning.

### 🐧 Operating Systems
*   🐧 **[Linux SRE Master Guide (Day 1-18)](./linux/LINUX-SRE-MASTER-NOTES.md)**: Fundamentals to Container Internals.

### ☁️ Amazon Web Services (AWS)
*   🔐 **[IAM Master Notes](./aws/IAM-SRE-MASTER-NOTES.md)**: Security, Policies, and Governance.
*   💻 **[EC2 Master Notes](./aws/EC2-SRE-MASTER-NOTES.md)**: Scaling, Instance Types, and Cost.
